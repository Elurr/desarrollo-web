 ...
 // Variables
 let uncoverclick = 0;
 let button1 = null; // boton con valor vacio null
 let button2 = null; // boton con valor vacio null
 let firstclick = null; // resultado vacio porque es desconocido
 let secondclick = null; // resultado vacio porque es desconocido
...
function timerunning()
{
    ...
    function unlocknumbers()
    {
        for (let i = 0; i <= 15; i++)
        {
            ...
            unlockbutton.innerHTML = pairnumbers[i];
    ...
    if (uncoverclick == 1) // pregunta si se a clickado 1 vez
    {
        ...
        button1.innerHTML = firstclick; // Guardamos el primer resultado para comparar con el segundo resultado
    ...
    else if (uncoverclick == 2) // preguna si se a clickado 2 veces
    {
        ...
        button2.innerHTML = secondclick; // guarda el segundo resultado para comparar
